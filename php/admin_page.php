  ...
  <title>Admin page</title>
		...
		function delete_data(id){
			if(confirm('Are you sure to delete the record ?')){
				window.location.href = 'deleteDetails.php?id='+id;
			}
		}
		</script>
...
<div id="admin-menu" >
    <i class='bx bx-menu' id="menu-icon"></i>
        ...
        <li><i class='bx bxs-dashboard'></i><a href="#" id="dashboard-link">Dashboard</a></li>
            ...
            <li><i class='bx bxs-user-account' ></i><a href="admin_profile.html">Profile</a></li>
            <li><i class='bx bx-chat' ></i><a href="admin_payments.php">Payments</a></li>
...
if($result->num_rows>0)
{
...

  {
    ...
    //view
    echo "<td><a href='viewDetails.php?id=".$row['applicant_id']."'><input class='view-button' type='submit' value='View'></a></td>";
   //edit
    echo "<td><a href='editDetails.php?id=".$row['applicant_id']."'><input class='edit-button'  type='submit' value='Edit'></a></td>";
    //delete
    //echo "<td><a href='deleteDetails.php?id=".$row['applicant_id']."'><input class='delete-button' onclick = 'delete_data($row['applicant_id']) type='submit' value='Delete'></a></td>
