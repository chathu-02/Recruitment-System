    ...
    <body>
        <header class="header">
            <nav class="navbar">
                ...
                <a href="../scontactus.html">Contact Us</a>
        ...
        <div class="wrapper">
            ...
            <div class="form-box login">
                ...
                <form action="login.php" method="POST">
                    ...
                    <div class="login-register">
                        <p>Don't have an account?<a href="register.php" class="register-link">Register</a><br><br>
                    </div>
            ...
            margin-left: 30%;">
                            <a href="systemlogin.php"><button class="btn" style="margin-top:5px;">System Login</button></a>
                            <a href="admin_login.php"><button class="btn" style="margin-top:5px;">Admin Login</button></a>
                            <a href="HR_login.php"><button class="btn" style="margin-top:5px;">HR Login</button></a>
                            <a href="recruiter_login.php"><button class="btn" style="margin-top:5px;">Recruiter Login</button></a>
            </div>
        <br>
        <br>
        <br>
